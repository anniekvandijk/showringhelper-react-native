...
export default {
  ...
  checkboxBgColor: platform === PLATFORM.IOS ? '#197b30' : '#197b30',
  ...
  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#e56228',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  sTabBarActiveTextColor: '#007aff',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#e56228' : '#ffffff',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#603913',
